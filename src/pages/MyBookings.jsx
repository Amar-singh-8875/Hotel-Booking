  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="max-w-6xl mt-8 w-full text-gray-800">
        <div
          className="hidden md:grid grid-cols-[3fr_2fr_1fr] w-full border-b
        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            {/* Payment Status */}
            <div className="flex flex-col items-start justi pt-3">
              ...
              {!booking.isPaid && (
                <button className="px-4 py-1.5 mt-4 text-xs border
                 border-gray-400 rounded-full hover:bg-gray-500 transi  cursor-pointer">
                    Pay Now</button>
              )}
            </div>
          </div>
